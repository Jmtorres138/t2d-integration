...
annotation.keyfile <- fgwas.dir %&% "plot-key.csv"# Optional: Specifiy if you have a tab-delimited txt file with annotation names (as they appear in the fgwas input file) on the left column and plotting names on the right column, column names should be Name and PlotName, otherwise set to NULL
