...
home_dir = "/well/got2d/jason/projects/t2d-integration/fgwas/diagram_hrc/peripheral-tissues/single/islet/chromseg-only/"
...
def step5(model_list,best_p,best_llk,best_dropped_mod="NA",previously_dropped=[]):
    ...
    for mod in model_list:
        ...
        if len(keep_list) <= 15:
            qc = "long.qc"#"short.qc" # testing this out
        else:
            qc = "long.qc"
