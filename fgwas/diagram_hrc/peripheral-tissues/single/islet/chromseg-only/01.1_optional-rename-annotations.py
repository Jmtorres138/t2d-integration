...
# globals
cur_dir = "/well/got2d/jason/projects/t2d-integration/fgwas/diagram_hrc/peripheral-tissues/single/islet/chromseg-only/"
input_dir = cur_dir + "fgwas_input/"

infile = input_dir+"diagram_hrc.fgwas.gz"
outfile = input_dir+"diagram_hrc.renamed.fgwas.gz"
