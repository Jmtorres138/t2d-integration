...
home_dir = "/well/got2d/jason/projects/t2d-integration/fgwas/diagram_hrc/peripheral-tissues/single/islet/"
in_dir=home_dir+"fgwas_input/"
out_dir = home_dir + "fgwas_output/"
input_file=in_dir+"diagram_hrc.renamed.fgwas.gz" # Optional: Run 01.1 script and use this for abbreviated annotations: in_dir+"diagram_hrc.renamed.fgwas.gz"
...
job_prefix = "islATAC_" # change this if you have concurrent runs of the fgwas_wrapper (for example, running wrapper seperately across tissues)
