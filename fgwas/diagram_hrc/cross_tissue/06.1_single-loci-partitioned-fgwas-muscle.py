...
in_dir=home_dir+"fgwas_input_" + tissue + "/"
out_dir = home_dir + "fgwas_output_" + tissue + "/"
...
input_file=in_dir+"ukbb_diamante-euro.fgwas.gz" # explicitly removing transcript and intron from analysis
...
def fgwas_run(annot_list):
    ...
    if "distance_tss" in annot_list:
        ...
        command_list = [fgwas, "-i", input_file, "-cc",  "-bed", bed_file,
                        ...
                        "-w", "+".join(a_list), "-print","-o", out_dir+"SINGLE_fgwas_run_loci-partition"]
    else:
        command_list = [fgwas, "-i", input_file, "-cc", "-bed", bed_file,
                        "-w", "+".join(annot_list), "-print","-o", out_dir+"SINGLE_fgwas_run_loci-partition"]
