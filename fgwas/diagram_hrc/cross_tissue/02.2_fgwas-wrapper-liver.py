...
in_dir=home_dir+"fgwas_input_liver/round2/"
out_dir = home_dir + "fgwas_output_liver/round2/"
...
job_prefix = "liver_" # change this if you have concurrent runs of the fgwas_wrapper (for example, running wrapper seperately across tissues)
