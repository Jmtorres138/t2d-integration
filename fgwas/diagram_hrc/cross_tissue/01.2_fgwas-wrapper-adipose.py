...
in_dir=home_dir+"fgwas_input_adipose/"
out_dir = home_dir + "fgwas_output_adipose/"
...
job_prefix = "adipose_" # change this if you have concurrent runs of the fgwas_wrapper (for example, running wrapper seperately across tissues)
