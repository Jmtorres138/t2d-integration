...
key_file = home_dir + "fgwas_input/annotation_key-file.txt"
...
def get_annot_list(best_param_file,key=True):
    out_list = []
...
def run_cred_sets():
    ...
    for loc in loc_list:
        print(loc)
        command_list5 = [rscript, "--vanilla",home_dir+"05.0_functional_credible_sets.R",loc]
