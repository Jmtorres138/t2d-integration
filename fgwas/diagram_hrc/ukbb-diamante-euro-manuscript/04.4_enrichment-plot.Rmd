...
fgwas.dir <- serv.dir %&% "projects/t2d-integration/fgwas/diagram_hrc/ukbb-diamante-euro-manuscript/"
...
plt
write.table(x=param.df,file=fgwas.dir %&% output.prefix %&% ".fgwas_enrich_t2d-loci-partition.joint.txt",
            sep="\t",quote=F,col.names=TRUE,row.names=FALSE)
ggsave(filename=fgwas.dir %&% output.prefix %&% ".fgwas_enrich_t2d-loci-partition.joint.png",plot=plt,width=6,height=6)
