...
Usage: python 04.3_loci-partitioned-fgwas.py
'''
# libraries
import sys,os,gzip
...
input_file=in_dir+"ukbb_diamante-euro_reduced.fgwas.gz" # explicitly removing transcript and intron from analysis
